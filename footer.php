<footer id="footer" class="dark" style="background: url('images/footer-bg.jpg') repeat fixed; background-size: 100% 100%;">
        ...
        <div class="footer-widgets-wrap clearfix">
            ...
            <div class="col_full">
                ...
                <div class="widget clearfix">
                    ...
                    <p>Logika <strong>Fuzzy</strong> adalah suatu proses pengambilan keputusan berbasis aturan yang bertujuan untuk memecahkan masalah, dimana sistem tersebut sulit untuk dimodelkan atau terdapat ambiguitas dan  ketidakjelasan yang berlimpah</p>
                    ...
                    <div class="col_half col_last">
                        <h4>Uji Kelayakan Angkutan Umum Menggunakan Fuzzy Logic</h4>
                        <p>Program Aplikasi ini diharapkan dapat mempermudah dalam melakukan pengujian kelayakan terhadap kendaraan umum, sehigga dalam prosesnya dapat memperbaiki pelayanan transportasi umum yang ada di <strong>Indonesia.</strong></p>
                    </div>
    ...
    <div id="copyrights">
        ...
        <div class="container clearfix">
            ...
            <div class="col_half">
                Copyrights &copy; 2017 All Rights Reserved by Kelompok 1.
            </div>
