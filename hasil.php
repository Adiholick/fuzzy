...
<div id="wrapper" class="clearfix">
    ...
    if(!empty($_POST['sistem_pengereman']) && !empty($_POST['rangka_landasan']) && !empty($_POST['gas_emisi'])){
        ...
        $hasil = $hitung->hitung($sistem_pengereman,$rangka_landasan,$gas_emisi);
                        ...
                        <div class="tab-container">
                            ...
                            <div class="tab-content clearfix" id="tabs-1">
                                <div class="col_full">
                                    ...
                                    <?php
                                    //require_once "koneksi.php";
                                    $sql = "SELECT MIN(rem) as min_rem, MIN(rangka) as min_rangka, MIN(emisi) as min_emisi, MAX(rem) as max_rem, MAX(rangka) as max_rangka, MAX(emisi) as max_emisi, AVG(rem) as rata_rem, AVG(rangka) as rata_rangka, AVG(emisi) as rata_emisi FROM `data_kendaraan`";
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td rowspan="3">Gas Emisi</td>
                                                <td>Rendah</td>
                                                <td rowspan="3">[<?php echo $min_emisi . " - ". $max_emisi; ?>]</td>
                                                <td>[<?php echo $min_emisi . " - ". $rata_emisi; ?>]</td>
                                            </tr>
                                            <tr>
                                                <td>Sedang</td>
                                                <td>[<?php echo $min_emisi . " - ". $max_emisi; ?>]</td>
                                            </tr>
                                            <tr>
                                                <td>Tinggi</td>
                                                <td>[<?php echo $rata_emisi . " - ". $max_emisi; ?>]</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="tab-content clearfix" id="tabs-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                        <?php
                                        $sql_linguistik = mysqli_query($con, "SELECT * FROM `rule` WHERE `rem` NOT IN('tinggi') AND `rangka` NOT IN ('tinggi') AND `emisi` NOT IN ('tinggi')") or die ("Gagal " . mysqli_error($con));
                                        while($tampil_linguistik = mysqli_fetch_array($sql_linguistik)){

                                            ///---- Fungsi Cari Minimal (Conjucntion) ada disini -----///
                                            $cari_min = array($hasil_rem[$tampil_linguistik['rem']], $hasil_rangka[$tampil_linguistik['rangka']], $hasil_emisi[$tampil_linguistik['emisi']]);
                                            ...
                                            <tr>
                                                ...
                                                <td>AND</td>
                                                <td>Emisi <?php echo $tampil_linguistik['emisi']; ?></td>
                                                <td>THEN</td>
                            ...
                            <div class="tab-content clearfix" id="tabs-4">
                                ...
                                <h4>Gas Emisi</h4>
                                <p>
                                    Rendah = (<?php echo $hasil_emisi['rendah']; ?>)<br>
                                    <?php
                                    echo "1 = ". $gas_emisi . " ≤ " . $min_emisi . "<br>";
                                    echo $min_emisi . " ≤ " . $gas_emisi . " ≤ " . $rata_emisi . "<br>";
                                    if($hasil_emisi['rendah'] !="0" && $hasil_emisi['rendah']!= "1"){
                                        echo "( " . $rata_emisi . " - " . $gas_emisi . " ) / ( " . $rata_emisi . " - " . $min_emisi . ")<br>";
                                    }
                                    echo "0 = ". $gas_emisi . " ≥ " . $rata_emisi . "<br>";
                                    ?>
                                </p>
                                <p>
                                    Sedang = (<?php echo $hasil_emisi['sedang']; ?>)<br>
                                    <?php
                                    echo "0 = ". $gas_emisi . " ≤ " . $min_emisi . " atau " . $gas_emisi . " ≥ " . $max_emisi . "<br>";
                                    echo $min_emisi . " ≤ " . $gas_emisi . " ≤ " . $rata_emisi . "<br>" ;
                                    if($hasil_emisi['sedang'] != "1" && $hasil_emisi['sedang'] != "0" ){
                                        echo "( " . $gas_emisi . " - " . $min_emisi . " ) / ( " . $rata_emisi . " - " . $min_emisi . ")<br>";
                                    }
                                    echo "1 = " . $rata_emisi . " ≤ " . $gas_emisi . " ≤ " . $max_emisi . "<br>";
                                    ?>
                                </p>
                            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        while($tampil_linguistik = mysqli_fetch_array($sql_linguistik)){
                                            ...
                                            <tr>
                                                ...
                                                <td>AND</td>
                                                <td>Emisi <?php echo $tampil_linguistik['emisi']. " (". $hasil_emisi[$tampil_linguistik['emisi']] .") " ; ?></td>
                                                <td>THEN</td>
